...
%macro sc12_finish;
  ...
  %let sc12_complete=1;
  %put NOTE: Evidence is descriptive selected development URL-free rows; A was AI-assisted and B was no-AI/no-prior-exposure attested. Consensus is not used as truth for metrics.;
